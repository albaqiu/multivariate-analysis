...
The Hierarchical Clustering on Principal Components (HCPC) method is applied to the scores obtained from the previously computed PCA. 
...
The PCA-based hierarchical clustering with four clusters reveals a clear grouping structure primarily driven by diamond size and price. Highly significant differences are observed across all main numerical variables, particularly carat, price, and physical dimensions (x, y, z), while depth and table provide additional discrimination among medium-sized diamonds. Categorical variables further refine this structure and highlight a clear size-quality trade-off across clusters.
...
\textbf{- Cluster 1 (black): Small, high-quality diamonds}
...
\textbf{- Cluster 2 (red): Medium-sized diamonds with lower clarity}
...
\textbf{- Cluster 3 (green): Large diamonds with lower quality indicators}
