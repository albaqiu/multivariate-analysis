...
In contrast, the second Gower dimension is mainly associated with variables describing geometric proportions. Although the projection of depth does not show a sharply defined gradient, higher depth values tend to appear in the upper part of the map, while lower depths are more frequent in the lower region. Conversely, table exhibits an opposite pattern, with larger table values concentrating toward the lower side of the configuration and smaller table values toward the upper side. Together, these patterns indicate that the second dimension captures a trade-off between taller, more pointed diamonds and flatter, wider ones, which is consistent with the interpretation of the second PCA component.

Together, these patterns indicate that the second dimension reflects variation in diamond geometry, distinguishing between more pointed diamonds with greater depth and shallower diamonds characterized by larger table values, in line with the interpretation of the second PCA component.
