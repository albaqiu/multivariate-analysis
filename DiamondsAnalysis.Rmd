...
The spatial distribution of the clusters in the PCA factor map further supports the validity of the clustering solution. In the Figure, clusters $1$ (black) and $4$ (blue) are located at opposite extremes of the first dimension, indicating a strong separation based on physical size and price. On the other hand, clusters $2$ (red) and $3$ (green) are mainly differentiated along the second dimension, reflecting differences in geometric proportions, clarity, and cut quality.
