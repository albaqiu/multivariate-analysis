...
res.ca_cut_color <- CA(tab_cut_color)

# Eigenvalues
res.ca_cut_color$eig
barplot(res.ca_cut_color$eig[,2], main="Eigenvalues")

# Row profiles
res.ca_cut_color$row$coord
res.ca_cut_color$row$contrib
res.ca_cut_color$row$cos2

# Column profiles
res.ca_cut_color$col$coord
res.ca_cut_color$col$contrib
res.ca_cut_color$col$cos2

# Plot
plot.CA(res.ca_cut_color)
```
### Cut x clarity
